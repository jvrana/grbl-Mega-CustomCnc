...
files etc as the project matures. I understand this has been done a million times over [(see openbuilds if you want actual build plans)](https://builds.openbuilds.com/), but *I* want to do it myself and have full control over the design.
